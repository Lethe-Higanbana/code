 ...
 * 代码生成器
 */
public class MysqlGenerato {
    //初始化文件路径
    private static String packageName="src/main";
    // 代码生成路径
    private static String customPath="mybatispluspage.page";
    //作者
    private static String authorName="zengfanbin";
    //表名
    private static String tableName="king_users";
    // 表前缀
    private static String tableFix="king";
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator autoGenerator=new AutoGenerator().setGlobalConfig(
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.summersky." + customPath)// 自定义包路径
